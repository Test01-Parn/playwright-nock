...
import { setupNock } from '../helpers/nockSetup';
...
test.describe('Test API On jsonPlaceHolder', () => {
  ...
  test.describe('#GET Method', () => {
    ...
    test('Get existing Posts should return posts details', async ({ request }) => {
    ...
    test('Get posts with alphabet should return errors', async ({ request }) => {
    ...
    test('Get Post comments should list of available comments under given post id.', async ({ request }) => {
    ...
    test('Get comment list form not exist Posts should return empty', async ({ request }) => {
      const res = await request.get('/posts/101/comments');
      const body = await res.json();
  ...
  test.describe('#POST Method', () => {
    ...
    test('Create New post with empty payload should be successful', async ({ request }) => {
      const res = await request.post('/posts', {
        data: {},
      });
      const body = await res.json();
  ...
  test.describe('#PUT Method', () => {
    ...
    test('Editing non-exist posts should be fail', async ({ request }) => {
